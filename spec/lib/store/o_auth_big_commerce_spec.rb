...
describe MadCart::Store::OAuthBigCommerce do # rubocop:disable Metrics/BlockLength, Metrics/LineLength
  ...
  describe 'store' do
    it 'expects instantiation with client id, store hash and access token' do
      expect do
